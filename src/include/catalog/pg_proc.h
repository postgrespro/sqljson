...
DATA(insert OID =  6047 (  jsonpath_query_safe PGNSP PGUID 12 1 1000 0 0 f f f f t t i s 2 0 114 "114 6050" _null_ _null_ _null_ _null_ _null_ json_jsonpath_query_safe2 _null_ _null_ _null_ ));
DESCR("jsonpath query, empty on error");
DATA(insert OID =  6048 (  jsonpath_query_safe PGNSP PGUID 12 1 1000 0 0 f f f f t t i s 3 0 114 "114 6050 114" _null_ _null_ _null_ _null_ _null_ json_jsonpath_query_safe3 _null_ _null_ _null_ ));
DESCR("jsonpath query, empty on error");
...
DESCR("implementation of ? operator");
DATA(insert OID =  6028 (  jsonpath_bind_jsonb PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 6050 "6050 3802" _null_ _null_ _null_ _null_ _null_ jsonpath_bind_jsonb _null_ _null_ _null_ ));
DESCR("implementation of @ operator");
