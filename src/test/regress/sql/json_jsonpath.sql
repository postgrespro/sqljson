...
select * from _jsonpath_query(json '[1, "2", null]', '$[*] ? (@ != null)');
select * from _jsonpath_query(json '[1, "2", null]', '$[*] ? (@ == null)');
...
select _jsonpath_query(json '[null, 1, "abc", "abd", "aBdC", "abdacb", "babc"]', 'lax $[*] ? (@ like_regex "^ab.*c")');
select _jsonpath_query(json '[null, 1, "abc", "abd", "aBdC", "abdacb", "babc"]', 'lax $[*] ? (@ like_regex "^ab.*c" flag "i")');
